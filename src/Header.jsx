...
//             {/* Right Section: Login + Language Dropdown (Desktop) */}
//             <div className="hidden lg:flex items-center lg:order-2 space-x-4 px-1 py-1 rounded-2xl">
//               <select
//                 onChange={changeLanguage}
//                 value={i18n.language}
//                 className="px-1 py-1 flex rounded text-grey-700 border-transparent bg-[#fefcf0] text-right"
...
//                 <option value="pu" className="text-center">Punjabi(ਪੰਜਾਬੀ)</option>
//                 <option value="od" className="text-center">Odia(ଓଡିଆ)</option>
//                 <option value="as" className="text-center">Assamese(অসমীয়া)</option>
//                 <option value="ur" className="text-center">Urdu(اردو)</option>
//               </select>
...
//             } bg-[#fefcf0] border-t border-gray-200`}
//           >
...
//             {/* Language & Login in Mobile Menu */}
//             <div className="flex flex-col space-y-3 px-4 py-3 border-t border-gray-200">
//               <select
//                 onChange={changeLanguage}
//                 value={i18n.language}
...
//                 to="/Login"
//                 onClick={closeMenu}
//                 className="flex items-center justify-center bg-[#f9be09] space-x-2 px-5 py-3 rounded-2xl"
//               >
//                 <span className="material-symbols-outlined">person</span>
//                 <b>{t("Log in")}</b>
//               </Link>
            ...
            <div className="flex items-center space-x-2 lg:space-x-4 order-2">
              ...
              <div className="flex items-center space-x-2">
                <select
                  onChange={changeLanguage}
                  value={i18n.language}
                  className="px-2 py-1 rounded text-gray-700 border border-gray-300 bg-white"
                > 
                  <option value="en">English</option>
                  <option value="gu">Gujarati(ગુજરાતી)</option>
